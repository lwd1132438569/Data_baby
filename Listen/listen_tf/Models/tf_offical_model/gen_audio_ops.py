...
from eager import execute as _execute
from eager import context as _context
from eager import core as _core
from eager import tensor as _tensor
...
def audio_spectrogram(input, window_size, stride, magnitude_squared=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("AudioSpectrogram", 1, inputs=_inputs_flat,
...
def decode_wav(contents, desired_channels=-1, desired_samples=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("desired_channels", desired_channels, "desired_samples",
              desired_samples)
    _result = _execute.execute("DecodeWav", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def encode_wav(audio, sample_rate, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [audio, sample_rate]
    _attrs = None
    _result = _execute.execute("EncodeWav", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def mfcc(spectrogram, sample_rate, upper_frequency_limit=4000, lower_frequency_limit=20, filterbank_channel_count=40, dct_coefficient_count=13, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("Mfcc", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
